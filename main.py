...
if __name__ == '__main__':
    ...
    parser.add_argument('--forecast_window', default=7, type=int, help='number of forecast time steps')
    parser.add_argument('--features_per_step', default=24, type=int,
    ...
    parser.add_argument('--train_share', default=0.6, type=float, help='fraction of dataset used for training')
    parser.add_argument('--tests_share', default=0.2, type=float, help='fraction of dataset used for testing')
    parser.add_argument('--reduce', default=None, type=float,
    ...
    parser.add_argument('--time_column_name', default=None, type=str, help='name of time data column in csv file')
    parser.add_argument('--data_column_names', default=None, type=str, help='name of data column in csv file')
    # TODO: add country, downsample rate, remove flatline, split by category and others

    # Training specifications
    parser.add_argument('--learning_rate', default=-3., type=float, help='log of learning rate')
    ...
    parser.add_argument('--profiling', action='store_true', default=False, help='enable training profiling')
