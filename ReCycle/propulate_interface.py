...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_name", default="oneshot_transformer", type=str, help="model to use"
    )
    parser.add_argument(
        "--dataset_name", default="uci_pt", type=str, help="dataset to use"
    )
    parser.add_argument(
        "--mode", default="evolve", type=str, help="chose evolve, extract or continue"
    )
